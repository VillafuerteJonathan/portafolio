			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-14 gap-x-12">
				{#each PROJECTS as p}
					...
					>
						<!-- Glow -->
						<div
							class="glow absolute inset-0 bg-gradient-to-r from-purple-600/10 to-blue-500/10
						...
						<div class="p-6 flex flex-col flex-1">
							<h3
								class="text-xl font-bold mb-2 text-purple-300 group-hover:text-purple-400 transition"
							>
								{p.title}
							</h3>
							...
							<div class="flex gap-3 mt-auto">
								...
								>
									<img src={github} class="w-5 opacity-80" />
									Código
								</a>
